...
export default function OpenGraphImage() {
  return new ImageResponse(
    ...
    >
      <p style={{ fontSize: 28, letterSpacing: 8, textTransform: "uppercase", opacity: 0.85, margin: 0 }}>Since 1998</p>
      <h1 style={{ fontSize: 72, fontWeight: 600, margin: "16px 0 0", textAlign: "center" }}>{siteConfig.name}</h1>
